    ...
    <body>
        ...
        <div id="principal" class="content">
            <div id="content" class="content-inside">
                <a id="cerrar" class="nohover" href="login/logout.php"><img src="images/logout.png" alt="Cerrar sesión"></a><h4>Bienvenido, <?php echo $_SESSION['usuario']['nick']?></h4>
                ...
                <div id="2" class="item"><a class="nohover" href="newslettermanagement.php"><img src="images/newsletter.png" alt="Gestión de newsletter"></a><a href="newslettermanagement.php" class="button">Gestión de Newsletter</a></div>

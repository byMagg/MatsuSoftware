    ...
    <body>
        ...
        <div id="principal" class="content">
            <div id="content" class="content-inside">
                ...
                <div id="3" class="item"><a class="nohover" href="projectmanagement.php"><img src="images/stats.png" alt="Gestión de Proyectos"></a><a href="" class="button">Gestión de Proyectos</a></div>
                <div id="4" class="item"><a class="nohover" href="videogamemanagement.php"><img src="images/games.png" alt="Gestión de Videojuegos"></a><a href="gestionVideojuego.php" class="button">Gestión de Videojuegos</a></div>

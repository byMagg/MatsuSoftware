                        ...
                        <div id="h1apps"><h1>VIDEOJUEGOS</h1></div>
                            <?php
                                ...
                                while($product = $resultado->fetch_assoc()){
                                    echo "
                                    <div class='item'><a class='nohover' href='videojuego.php'><img src='".$product['photoLink']."' alt='Foto'><div><h2>".$product['title']."</h2><h4>- Precio: ".$product['price']." €</h4></div></div></a>
                                    ";
                                }
                            ?>
                    </div>
                    <div id="merchandising">
                        <div id="h1merch"><h1>MERCHANDISING</h1></div>
                            <?php
                                ...
                                while($product = $resultado->fetch_assoc()){
                                    echo "
                                    <div class='item'><a class='nohover' href='merchandising.php'><img src='".$product['photoLink']."' alt='Foto'><div><h2>".$product['title']."</h2><h4>- Precio: ".$product['price']." €</h4></div></div></a>
                                    ";
                                }
                            ?>
                    </div>

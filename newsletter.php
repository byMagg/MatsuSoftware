        ...
        <div class="content">
            <div id="content" class="content-inside">
                ...
                <div id="tabla">
                    <table>
                        <tr>
                            <td><img class="delete" src="images/paisaje.jpg" alt="Usuario"></td>
                            <td>Vestibulum commodo sed sem non pellentesque. In arcu metus, efficitur eu velit vel, imperdiet interdum magna. Praesent mollis arcu felis. Integer scelerisque tortor eu vulputate convallis. Morbi vestibulum viverra neque, a pulvinar elit dictum vel. Etiam elementum augue ac lacinia blandit. Donec sollicitudin tellus lacus, at ullamcorper tellus tempor vel. Nullam feugiat suscipit condimentum.</td>

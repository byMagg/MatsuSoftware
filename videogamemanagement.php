                ...
                <div id="cuadricula">
                    ...
                    <div id="form">
                        ...
                        <form id="videogamemanagement" action="">
                            <div class="halfleft">
                                <label>Título:</label>
                                <input type= "text" name="titulo" maxlength="50" title="El título debe de contener enter 0 y 50 carácteres." placeholder=" Introduce el título" required/>
                                <label>Precio:</label>
                                <input type= "text" name="price" placeholder=" Introduce el precio" pattern="[0-9.]{0,10}" required/>
                                <label>Descripción:</label>
                                <textarea type="msg" name="description" maxlength="498" title="El texto debe de contener enter 0 y 500 carácteres." placeholder=" Introduce la descripcion"  required></textarea>
                                <label>Link de compra:</label>
                                <input type= "text" name="linkpurchase" maxlength="1000" title="El link debe de contener enter 0 y 1000 carácteres." placeholder=" Introduce el link" required/>
                            </div>
                            <div class="halfright">
                                <label>Link de la foto:</label>
                                <input type= "text" name="linkphoto" maxlength="1000" title="El link debe de contener enter 0 y 1000 carácteres." placeholder=" Introduce el link"  required/>
                                <label>Link del trailer:</label>
                                <input type= "text" name="linktrailer" maxlength="1000" title="El link debe de contener enter 0 y 1000 carácteres." placeholder=" Introduce el link" required/>
                                <label>Requisitos del sistema:</label>
                                <textarea type="msg" name="requisito" maxlength="498" title="El texto debe de contener enter 0 y 500 carácteres." placeholder=" Introduce los requisitos" required></textarea>
